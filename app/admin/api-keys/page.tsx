...
import { Home, ArrowLeft, Search, RefreshCw, Key, Shield } from "lucide-react";
...
export default function AdminApiKeys() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden">
      ...
      <div className="relative z-20 flex items-center justify-center min-h-screen px-4 pt-20 pb-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="mt-12"
          >
            <p className="text-gray-400 mb-4">Admin Panel:</p>
