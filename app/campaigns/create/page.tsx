    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 pt-24 pb-12 px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/20 border border-blue-500/20 rounded-xl p-6 mb-6">
            <div className="flex-1">
              ...
              <div className="bg-blue-500/5 border border-blue-500/20 rounded-lg p-4 space-y-2">
                ...
                <ol className="text-sm text-gray-300 space-y-1.5 ml-4 list-decimal">
                  <li>
                    Fill in YOUR contact information below (name, email, phone,
                    etc.)
                  </li>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-6">
          ...
          <p className="text-xs text-gray-400 mb-3">
            Give your campaign a memorable name so you can find it later (e.g.,
            "January Outreach", "Partnership Campaign Q1")
          </p>
          <input
            id="campaignName"
            type="text"
        ...
        <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-6">
          <div className="mb-5">
            ...
            <p className="text-xs text-gray-400 leading-relaxed">
              Fill in YOUR details below. The bot will automatically detect form
              fields on each company's website and fill them with this
              information.{" "}
              <strong className="text-gray-300">All fields are optional</strong>{" "}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Your Name */}
            <div>
              <label className="block text-xs text-white mb-2">Your Name</label>
              <input
                type="text"
                value={senderName}
            ...
            <div className="md:col-span-2">
              <label className="block text-xs text-white mb-2">Subject</label>
              <input
                type="text"
                value={subject}
...
Best regards"
          ...
          <div className="mt-3 p-3 bg-green-500/10 border border-green-500/20 rounded-lg">
            <p className="text-xs text-green-300">
              The bot will automatically find and fill the message field on each
              company's contact form
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-500/5 to-purple-500/5 border border-blue-500/20 rounded-xl p-6">
          <div className="mb-4">
            ...
            <p className="text-xs text-gray-400">
              ...
              {uploadedData.validRows} companies automatically using the "Rapid
              All" button on the next page.
            </p>
          </div>
          <div className="flex items-center justify-between gap-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="group flex items-center px-8 py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white text-sm font-semibold
            ...
            >
              {loading ? "Creating Campaign..." : "Create Campaign & Continue"}
            </button>
          </div>
        </div>
      </form>
