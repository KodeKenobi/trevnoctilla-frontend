  ...
  .then(html => {
    ...
    if (matches) {
      ...
      matches.forEach((match, i) => {
        ...
        if (match.includes('visibility:hidden') || match.includes('visibility: hidden')) {
      ...
      console.log('\n=== CONCLUSION ===');
      console.log('If links have opacity:0 or display:none, is_visible() returns FALSE');
      console.log('Async scraper ALSO checks is_visible() - so why does it work?');
      console.log('\nPossible reasons:');
